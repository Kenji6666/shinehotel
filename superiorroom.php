...
<html lang="en">
      ...
      <div class="container">
        <div class="row">
          <div class="col-md-6 mt-5 mx-auto text-center mb-1 section-heading">
            <h2 class="mb-1" style="color: red;">Superior Rooms</h2>
            <hr width="100%" size="50px" color="red" style="align-items: center;"></hr>
          </div>
        </div>
        <div class="row">
          <div class="col-md-9 mx-auto text-center mb-1">
            <h4>Pengalaman kamar Hotel yang nyaman di dalam luas 37 meter persegi, Kamar Superior kami adalah pilihan yang baik untuk tamu yang ingin menikmati kamar Hotel modern di mana bentuk, fungsi, dan gaya semuanya menyatu untuk pengalaman Hotel yang dapat memenuhi semua kebutuhan Anda. Untuk kenyamanan dan privasi eksklusif. Fitur termasuk panggilan lokal gratis, surat kabar</h4>
          </div>
        </div>
      </div>
    </div>
  ...
  <table class="table" style="width: 70%;">
    ...
    include 'koneksi.php';
    $no = 1;
    $data = mysqli_query($koneksi,"select fitur from tb_fasilitas_kamar where id = '3'");
    ...
    <a class="btn btn-primary btn-lg" href="../login/index.php" role="button">Book Now</a>
        ...
        <div class="nonloop-block-15 owl-carousel">
            <div class="media-with-text p-md-4">
              <div class="img-border-sm mb-4">
                <a href="#" class="popup-vimeo image-play">
                  <img src="images/kingbed2.jfif" alt="" class="img-fluid">
                </a>
              </div>
            ...
            <div class="media-with-text p-md-4">
              <div class="img-border-sm mb-4">
                <a href="#" class="popup-vimeo image-play">
                  <img src="images/twinbed2.jfif" alt="" class="img-fluid">
                </a>
              </div>
            ...
            <div class="media-with-text p-md-4">
              ...
              <span class="mb-3 d-block post-date">`1Dec 20th, 2019 &bullet; By <a href="#">Shine Hotel</a></span>
              <p>Kamar mandi pada Superior Room di lengkapi dengan shower, wastafel dan dinding kaca, lebih luas dari standard room, dan kami menjamin kebersihan nya</p>
            </div>
            ...
            <div class="media-with-text p-md-4">
              ...
              <h2 class="heading mb-0"><a href="#">Bathroom</a></h2>
              <span class="mb-3 d-block post-date">`1Dec 20th, 2019 &bullet; By <a href="#">Shine Hotel</a></span>
              <p>Kamar mandi pada Superior Room di lengkapi dengan shower, watafel dan dinding kaca, lebih luas dari standard room, dan kami menjamin kebersihan nya</p>
            </div>
