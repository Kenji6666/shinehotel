...
<!-- navbar end -->
  ...
  <div class="container bg-white" style="padding: 20px; border-radius: 8px;">
		<div class="card-header ">
			<h4 class="card-title text-center">Fasilitas Kamar</h4>
		</div>
  ...
  <tbody>
   ...
   <?php
		include 'koneksi.php';
		$no = 1;
		$data = mysqli_query($koneksi,"select * from tb_fasilitas_kamar");
	 ...
	 ?>
         ...
         <form action="edit_fasilitas.php" method="post"><td><a href="edit_fasilitas.php?id=<?php echo $d['id']; ?>"><button type="button" class="btn btn-primary btn-sm" style="height: 27px; margin-right: 5px;">Edit</button></a></form>
      </a>
