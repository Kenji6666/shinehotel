...
<body>
	...
	include "koneksi.php";
	$id_kamar = $_GET['id'];
	$query = "select * from tb_harga where id_kamar='$id_kamar'";
  ...
  <div class="card-body">
    <h5 class="card-text fst-italic"><?php echo "$tipe_kamar"; ?></h5>
		  <div class="form-group mb-3 mt-4">
		  	<h5 class="text-center fw-bold">Masukkan Harga Baru</h5>
		  		<input type="text" name="price" class="form-control text-center" value="<?php echo "$harga"?>" style="height: 50px; width: 363px;"></input>
		  	</label>
