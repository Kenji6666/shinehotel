 ...
 <nav class="navbar navbar-expand-lg navbar-dark bg-dark text-center">
  <div class="container-fluid">
    ...
    <h4 class="text-white text-left" style="margin-right: 100px; padding-top: 8px; font-family: serif;">Shine Hotel | Petugas</h4>
      ...
      <ul class="navbar-nav me-auto mb-2 mb-lg-0">
        <li class="nav-item">
          <a class="nav-link active text-danger" aria-current="page" href="price.php">Price</a>
        </li>
      </ul>
      ...
      <ul class="navbar-nav me-auto mb-2 mb-lg-0">
        <li class="nav-item">
          <a class="nav-link text-white" aria-current="page" >User</a>
        </li>
      </ul>
...
<div class="col-13" style="padding: 80px; padding-top: 50px !important; background-image: url(gedung.jfif); min-height: 443px !important; height: 100%;">
	<div class="container bg-white" style="padding: 20px; border-radius: 8px;">
		<div class="card-header ">
			<h4 class="card-title text-center">Price List</h4>
		</div>
  ...
  <thead>
    <tr  class="table-danger">
     <th width="5px">No.</th>
	   <th width="20px">Tipe Kamar</th>
	   <th width="35px">Harga</th>
  ...
  <?php
	...
	?>
	 <tr>
		...
		<td>
			<a href="edit_price.php?id=<?php echo $d['id_kamar']; ?>"><button type="button" class="btn btn-primary btn-sm" style="height: 27px; margin-right: 5px;">Edit</button></a>
			</a>
		</td>    
	 </tr>
	<?php
