        ...
        <div class="site-navbar bg-light">
          <div class="py-1">
            <div class="row align-items-center">
              <div class="col-2">
                <h2 class="mb-0 site-logo"><a href="index.php">Shine</a></h2>
              </div>
              <div class="col-10">
                    ...
                    <ul class="site-menu js-clone-nav d-none d-lg-block">
                      ...
                      <li class="has-children">
                        ...
                        <ul class="dropdown arrow-top">
                          ...
                          <li><a href="superiorroom.php">Superior Room</a></li>
                          <li><a href="deluxeroom.php">Deluxe Room</a></li>
                        </ul>
                      </li>
                      <li><a href="about.php">Fasilitas</a></li>
                      <a class="btn btn-primary btn-md" href="../login/index.php" role="button">Book Now</a>
                    </ul>
                  </div>
                </nav>
              </div>
 ...
 <div class="site-section block-15">
      <div class="container">
        <div class="row">
         ...
         <div class="row">
          <div class="col-md-9 mx-auto text-center mb-1">
            <h4>Di Shine Hotel, filosofi kami adalah tentang kenyamanan dan perhatian tamu. Terinspirasi oleh warisan lokal, setiap properti di bawah Shine Hotel berusaha untuk menciptakan suasana santai dan pengalaman tamu dengan menawarkan suasana yang tenang, fasilitas yang terus diperbarui dan layanan khusus yang disampaikan dengan senyum dan ketulusan yang selalu selaras dengan lingkungan lokal </h4>
          </div>
      </div>
    </div>
</div>

 <div class="site-section block-15 mb-0">
      <div class="container mb-0">
        <div class="row mb-0">
          <div class="col-md-6 mx-auto text-center section-heading mb-0">
            <h2>Our Room</h2>
            <hr width="50%" size="50px" color="red" style="align-items: center; margin-bottom: 0px;"></hr>
          </div>
        </div>
      </div>
        ...
        <div class="row align-items-center">
          <div class="col-md-6 mb-5 mb-md-0">
              ...
              <div class="img-border">
                <a href="singleroom.php">
                  ...
                  <img src="images/bathroom.jfif" alt="" class="img-fluid">
                </a>
              </div>
              <a href="singleroom.php">
              <img src="images/singleroom.jfif" alt="Image" class="img-fluid image-absolute" style="height: 230px; width: 330px;">
              </a>
          </div>
          <div class="col-md-5 ml-auto">
            ...
            <div class="section-heading text-left">
              <h2 class="mb-5">Single Room</h2>
            </div>
            <p class="mb-4">Single Room dilengkapi dengan salah satu tempat tidur single. Luas kamar 20m². Kamar juga dilengkapi unit AC, kursi yang nyaman, cermin rias, dan kamar mandi. Desain kamar ini mengutamakan kenyamanan yang akan membuat anda melupakan ukuran ruang.</p>
            <p><a href="singleroom.php">Read More <span class="icon-arrow-right small"></span></a></p>
          </div>
        </div>
      </div>
    </div>
      ...
      <div class="container">
        <div class="row align-items-center">
          <div class="col-md-6 mb-5 mb-md-0">
              ...
              <a href="standardroom.php">
              <img src="images/queenbed.jpg" alt="Image" class="img-fluid image-absolute" style="height: 230px; width: 330px;">
              </a>
          </div>
          <div class="col-md-5 ml-auto">
            ...
            <div class="section-heading text-left">
              <h2 class="mb-5">Standard Room</h2>
            </div>
            <p class="mb-4">Ruang pada Standard Room dimaksimalkan dengan menggunakan furnitur dan perlengkapan yang dipilih dengan cermat. Didekorasi dengan gaya tradisional sederhana dengan kain dalam warna klasik dan mengutamakan kenyamanan anda</p>
            <p><a href="standardroom.php">Read More <span class="icon-arrow-right small"></span></a></p>
          </div>
        </div>
      </div>
    </div>
      ...
      <div class="container">
        <div class="row align-items-center">
          <div class="col-md-6 mb-5 mb-md-0">
              ...
              <div class="img-border">
                <a href="superiorroom.php">
                  <img src="images/bathroom2.jfif" alt="" class="img-fluid">
                </a>
              </div>
              <a href="superiorroom.php">
              <img src="images/kingbed2.jfif" alt="Image" class="img-fluid image-absolute" style="height: 230px; width: 330px;">
              </a>
          </div>
          <div class="col-md-5 ml-auto">
            ...
            <div class="section-heading text-left">
              <h2 class="mb-5">Superior Room</h2>
            </div>
            <p class="mb-4">Kamar Superior kami adalah pilihan yang baik untuk tamu yang ingin menikmati kamar Hotel modern di mana bentuk, fungsi, dan gaya semuanya menyatu untuk pengalaman Hotel yang dapat memenuhi semua kebutuhan Anda.</p>
            <p><a href="superiorroom.php">Read More <span class="icon-arrow-right small"></span></a></p>
          </div>
        </div>
      </div>
    </div>
      ...
      <div class="container">
        <div class="row align-items-center">
          <div class="col-md-6 mb-5 mb-md-0">
              ...
              <div class="img-border">
                <a href="deluxeroom.php">
                  <img src="images/bathroom3.jfif" alt="" class="img-fluid">
                </a>
              </div>
              <a href="deluxeroom.php">
              <img src="images/kingbed3.jfif" alt="Image" class="img-fluid image-absolute" style="height: 230px; width: 330px;">
              </a>
          </div>
          <div class="col-md-5 ml-auto">
            ...
            <div class="section-heading text-left">
              <h2 class="mb-5">Deluxe Room</h2>
            </div>
            <p class="mb-4">Deluxe Room menyambut Anda dengan kenyamanan modern dan dekorasi elegan. Nikmati pilihan panorama dari jendela setinggi langit-langit kami, atau tarik tirai gelap untuk menikmati tidur lelap pada siang atau malam hari.</p>
            <p><a href="deluxeroom.php">Read More <span class="icon-arrow-right small"></span></a></p>
          </div>
        </div>
      </div>
    </div>
