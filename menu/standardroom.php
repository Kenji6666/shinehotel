      ...
      <div class="container">
        <div class="row">
          <div class="col-md-6 mt-5 mx-auto text-center mb-1 section-heading">
            <h2 class="mb-1" style="color: red;">Standard Rooms</h2>
            <hr width="100%" size="50px" color="red" style="align-items: center;"></hr>
          </div>
        </div>
        <div class="row">
          <div class="col-md-9 mx-auto text-center mb-1">
            <h4>Ruang pada Standard Room dimaksimalkan dengan menggunakan furnitur dan perlengkapan yang dipilih dengan cermat. Didekorasi dengan gaya tradisional sederhana dengan kain dalam warna klasik. Desain kamar ini mengutamakan kenyamanan yang akan membuat anda melupakan ukuran ruang, sebaiknya tenggelam dalam kenyamanan yang ditawarkan kamar ini. Untuk kenyamanan dan privasi eksklusif, terdapat panggilan lokal gratis, dan surat kabar</h4>
          </div>
        </div>
      </div>
    </div>
  ...
  <table class="table" style="width: 70%;">
    <tbody>
     ...
     <tr>
        ...
        <td class="text-right">Queen or Twin</td>
     </tr>
     <tr>
     ...
     <tr>
        ...
        <?php
    include 'koneksi.php';
    $data = mysqli_query($koneksi,"select fitur from tb_fasilitas_kamar where id = '2'");
    ...
    <a class="btn btn-primary btn-lg" href="../login/index.php" role="button">Book Now</a>
        ...
        <div class="nonloop-block-15 owl-carousel">
            ...
            <div class="media-with-text p-md-4">
              <div class="img-border-sm mb-4">
                <a href="#" class="popup-vimeo image-play">
                  <img src="images/queenbed.jpg" alt="" class="img-fluid">
                </a>
              </div>
              <h2 class="heading mb-0"><a href="#">Queenbed</a></h2>
              <span class="mb-3 d-block post-date">Dec 20th, 2019 &bullet; By <a href="#">Shine Hotel</a></span>
              <p>Queenbed adalah tempat tidur dengan ukuran 160x200 cm, ini cukup untuk nyaman untuk di pakai oleh 2 orang dewasa, warna kasur dipilih dengan cermat demi kenyamanan Anda</p>
            </div>
            ...
            <div class="media-with-text p-md-4">
              <div class="img-border-sm mb-4">
                <a href="#" class="popup-vimeo image-play">
                  <img src="images/twinbed.jpg" alt="" class="img-fluid">
                </a>
              </div>
              <h2 class="heading mb-0"><a href="#">Twin bed</a></h2>
              <span class="mb-3 d-block post-date">Dec 20th, 2019 &bullet; By <a href="#">Shine Hotel</a></span>
              <p>Kami menyediakan pilihan kamar dengan twin bed untuk menyesuaikan kebutuhan Anda berdua yang ingin tidur dengan tempat tidur terpisah</p>
            </div>
            ...
            <div class="media-with-text p-md-4">
              ...
              <span class="mb-3 d-block post-date">Dec 20th, 2019 &bullet; By <a href="#">Shine Hotel</a></span>
              <p>Tentu saja terdapat kamar mandi pada standar room, di lengkapi dengan shower dan wastafel, kami selalu menjaga kebersihan nya demi kenyamanan Anda</p>
            </div>
