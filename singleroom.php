      ...
      <div class="container">
        <div class="row">
          <div class="col-md-6 mt-5 mx-auto text-center mb-1 section-heading">
            <h2 class="mb-1" style="color: red;">Single Rooms</h2>
            <hr width="100%" size="50px" color="red" style="align-items: center;"></hr>
          </div>
        </div>
        <div class="row">
          <div class="col-md-9 mx-auto text-center mb-1">
            <h4>Single Room dilengkapi dengan salah satu tempat tidur single. Luas kamar 20m². Kamar juga dilengkapi unit AC, kursi yang nyaman, cermin rias, dan kamar mandi. Desain kamar ini mengutamakan kenyamanan yang akan membuat anda melupakan ukuran ruang, sebaiknya tenggelam dalam kenyamanan yang ditawarkan kamar ini. Anda akan menikmati pemandangan kota yang sempurna dengan banyak landmark kota karena hotel kami adalah salah satu lokasi dengan peringkat teratas</h4>
          </div>
        </div>
      </div>
    </div>
  ...
  <table class="table" style="width: 70%;">
    <tbody>
     ...
     <tr>
        ...
        <?php
    include 'koneksi.php';
    $data = mysqli_query($koneksi,"select fitur from tb_fasilitas_kamar where id = '1'");
    ...
    <a class="btn btn-primary btn-lg" href="../login/index.php" role="button">Book Now</a>
        ...
        <div class="nonloop-block-15 owl-carousel">
            ...
            <div class="media-with-text p-md-4">
              <div class="img-border-sm mb-4">
                <a href="#" class="popup-vimeo image-play">
                  <img src="images/singleroom.jfif" alt="" class="img-fluid">
                </a>
              </div>
              <h2 class="heading mb-0"><a href="#">Singlebed </a></h2>
              <span class="mb-3 d-block post-date">Dec 20th, 2019 &bullet; By <a href="#">Shine Hotel</a></span>
              <p>Singlebed adalah tempat tidur dengan ukuran 100x200 cm, ini cukup untuk nyaman untuk di pakai oleh 1 orang dewasa, warna kasur dipilih dengan cermat demi kenyamanan Anda</p>
            </div>
            ...
            <div class="media-with-text p-md-4">
              ...
              <span class="mb-3 d-block post-date">Dec 20th, 2019 &bullet; By <a href="#">Shine Hotel</a></span>
              <p>Kamar mandi pada Single Room di lengkapi dengan shower, wastafel dan dinding kaca, dengan dan kami menjamin kebersihan nya</p>
            </div>
